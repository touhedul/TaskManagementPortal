        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"><span class="text-primary">Admin Login Info</span></div>
                        ...
                        <table id="datatable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $admin->last_login_ip }}</td>
                                    <td class="text-center">
                                        {{ \Carbon\Carbon::parse($admin->last_login_at)->diffForHumans() }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
